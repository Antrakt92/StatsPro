...
![StatsPro localization preview — live HUD label examples with offensive, tertiary, defensive, item level, durability, and coin-style repair cost rows across all 11 Retail locales](screenshots/localization.png)
