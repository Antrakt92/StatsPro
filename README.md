...
| `/ss selftest [all]` | Collect out-of-combat and combat diagnostic samples, then show a copyable report; `all` also summarizes DoYouNeedIt/ApplicantScout reports |
