...
-- Secret returns may drive only the guarded visibility path; display formatting
-- accepts clean finite numbers and otherwise emits an explicit unknown marker.
