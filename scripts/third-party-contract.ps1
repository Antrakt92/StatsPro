...
function Get-StatsProThirdPartyContract {
    return @(
        ...
        [pscustomobject][ordered]@{
            ...
            SourceRevision       = "r176"
            SourceArtifact       = "LibSharedMedia-3.0-v12.1.0.zip"
            SourceArtifactSha256 = "14BEB11FCC1082C7B846960FDE39596147A769A807601ECB0AEC4DE60750956D"
            RuntimeSha256        = "B2650FC5ACBFF310C7F7A23A36C8026A99D2441982D4B4F63AFB76489D56B214"
            ...
            LicenseDeclarationSource = "https://repos.curseforge.com/wow/libsharedmedia-3-0/!svn/rvr/176/trunk/LibSharedMedia-3.0/LibSharedMedia-3.0.lua"
            LicenseDeclarationSha256 = "EA359E44EAE4355C51A49A69960C878889EE26ADAC9D72D1362C22A3DB6AF6D0"
            CopyrightNoticeSource    = ""
            CopyrightNoticeSha256    = ""
            LicenseTemplateSource    = ""
            LicenseTemplateSha256    = ""
